...
export function LandingHero() {
  ...
  return (
    <section className="px-4 pb-18 pt-12 sm:px-6 sm:pb-24 lg:px-8 lg:pt-18">
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[0.94fr_1.06fr] lg:gap-18">
        <div className="max-w-xl">
          <Badge className="rounded-full border border-primary/18 bg-[linear-gradient(135deg,rgba(56,87,255,0.14),rgba(14,165,233,0.08))] px-4 py-2 text-primary shadow-[0_18px_34px_-24px_rgba(56,87,255,0.48)]">
            Personal finance, without the spreadsheet chaos
          </Badge>
          <h1 className="mt-7 text-5xl font-semibold tracking-[-0.085em] text-foreground sm:text-6xl lg:text-[4.6rem] lg:leading-[0.98]">
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-3">
            {trustPoints.map((item) => (
              <div key={item} className="flex items-center gap-3 rounded-2xl border border-border/70 bg-card/72 px-4 py-3 shadow-[0_16px_36px_-30px_rgba(15,23,42,0.24)] backdrop-blur-xl">
        ...
        <div className="relative lg:pl-4">
          ...
          <div className="landing-preview-frame group relative">
